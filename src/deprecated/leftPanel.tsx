...
const LeftPanel = () => {
  ...
  const slidingImage: Array<{ id: number; img: string; quote: string }> = [
    { id: 1, img: "/image/auth5.jpg", quote: "In a time of deceit telling the truth is a revolutionary act" },
    { id: 2, img: "/image/auth6.jpg", quote: "There is no charm equal to tenderness of heart." },
    { id: 3, img: "/image/auth7.jpg", quote: "The secret of getting ahead is getting started." },
    { id: 4, img: "/image/auth8.jpg", quote: "You cannot find peace by avoiding life." },
  ];
      ...
      {slidingImage.map((image, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-between h-full text-white z-10 px-4">
            <span className="pt-5 flex justify-end">
              <LogoSolra />
            </span>
